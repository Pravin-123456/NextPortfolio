    ...
    <section id={id} className="relative min-h-screen w-full flex flex-col justify-center py-24 overflow-hidden">
      ...
      <div className="container mx-auto px-6 md:px-12 xl:px-16 2xl:px-24 relative z-10">
        ...
        <MotionH2
          ...
          className="text-5xl md:text-4xl 2xl:text-6xl font-bold text-white mb-20 2xl:mb-32 text-start"
        >
          SERVICES
        </MotionH2>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8 xl:gap-12 w-full max-w-6xl justify-items-center">
            {serviceData.map((item, index) => (
              <MotionDiv
                ...
                className={`relative bg-white/5 rounded-2xl p-8 pt-16 w-full min-h-[220px] text-left backdrop-blur-md shadow-lg border border-white/10 group hover:border-purple-500/30 transition-all duration-300 ${index === serviceData.length - 1 && serviceData.length % 2 !== 0
